...
class ElectionController {
    ...
    async toggleActive(req, res) {
        try {
            ...
            const chainElection = election.blockchain_election_id ? await contract.elections(election.blockchain_election_id) : { startTime: 0n, isActive: false };
            ...
            console.error('Error toggling election status:', error.message, error.stack);
            res.status(500).json({ message: error.message });
        }
    }
